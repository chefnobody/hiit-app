...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { age: @athlete.age, first_name: @athlete.first_name, last_name: @athlete.last_name } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { age: @athlete.age, first_name: @athlete.first_name, last_name: @athlete.last_name } }
